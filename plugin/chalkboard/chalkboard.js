...
******************************************************************/
	...
	// Read pen width configuration, with defaults matching original hardcoded values
	var penWidth = config.penWidth !== undefined ? config.penWidth : 3;
	var chalkWidth = config.chalkWidth !== undefined ? config.chalkWidth : 7;
	switch ( theme ) {
		case "whiteboard":
